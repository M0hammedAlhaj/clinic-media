package com.spring.clinicmedia.presentation.filterSecuirty;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (headerAuthorization != null && headerAuthorization.startsWith("Bearer ")) {
            ...
            userName = extractClaimEmail.execute(token);
        }
        ...
        if (userName != null &&
            ...
            UserDetails userDetails = customUserDetailedService.loadUserByUsername(userName);

            baseHandler.handle(token);
